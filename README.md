...
La plus part préfère IDA en ce qui concerne L'Analyse des fichiers binaire etc ... en fait moi aussi,, mais par habitude avec les binaire (exe) je me sens plus à l'aise avec Olly !
...
PS : Le binaire est pleins d'Anti-Debug,, ça dérange je sais :p' ... on va les detectés peu à peu et puis on va les éliminés (avec un simple patching) ...
